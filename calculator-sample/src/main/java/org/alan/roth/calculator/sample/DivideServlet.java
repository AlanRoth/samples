...
import static org.alan.roth.calculator.sample.Calculator.performCalculation;
...
public class DivideServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(performCalculation(value1, value2, (v1, v2) -> {
                if(v2.equals(BigDecimal.ZERO)) return BigDecimal.ZERO;
                return v1.divide(v2);
            }));
        }
    }
